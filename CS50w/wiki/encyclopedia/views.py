...
def entry(request, entry_name):
    ...
    if html is None:
        return render(
            request, "encyclopedia/wrong_entry.html", {"entryTitle": entry_name}
        )
    else:
        return render(
            request,
...
def search(request):
    if request.method == "POST":
        ...
        if input in entries:
            return render(
                request, "encyclopedia/entry.html", {"entry": html, "entryTitle": input}
            )
        else:
            search_pages = []
    ...
    if request.method == "POST":
        ...
        if input_title in entries:
            ...
            return render(
                request,
                "encyclopedia/entry.html",
                {"entry": html, "entryTitle": input_title},
            )
...
def rand(request):
    ...
    return render(
        request, "encyclopedia/entry.html", {"entry": html, "entryTitle": entry_title}
    )
...
def edit(request):
    if request.method == "POST":
        ...
        return render(
            ...
            {"entry": text, "entryTitle": input_title},
        )
